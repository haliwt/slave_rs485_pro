...
/**********************************************************************************************************
*
*	Function Name: BEBufToUint16
*	Function: data is type (Big Endian) be changed datat is type (Little Endian)
*	Input Ref: _pBuf : data pointer
*	Return Ref: is big endian data
*  
**********************************************************************************************************/
...
/**********************************************************************************************************
*
*	Function Name: LEBufToUint16
*	Function:  data is type (Little Endian) be changed datat is type (Big Endian)
*	Input Ref: _pBuf input data of pointer
*	Return Ref: 
*
**********************************************************************************************************/
